    ...
    <section className="w-full h-screen flex flex-col md:flex-row items-center justify-center px-6 md:px-24">
      ...
      <div className="w-full h-full md:w-1/2 flex justify-center">
        <img
          src={assets.phone}
          alt="Delve App"
          className="w-[250px] h-full  md:w-[300px] object-contain"
        />
      </div>

      {/* Right Side - Text & CTA */}
      <div className="w-full md:w-1/2 flex flex-col text-center items-center h-full justify-center gap-4 mt-8 md:mt-0">
