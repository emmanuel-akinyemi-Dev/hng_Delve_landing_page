...
const Footer = () => {
  return (
    <footer className="bg-purple-600 text-white flex flex-col items-center justify-center py-12">
      <div className="text-4xl">
        <img src={assets.delvelogo} alt="" />
      </div>
      <h2 className="text-2xl font-semibold mt-4">Delve</h2>
      <a
        href="https://drive.google.com/file/d/1tOR77Ixu77h_yNcM5-ubIrAa8UG91hdB/view?usp=sharing"
        target="_blank"
        rel="noopener noreferrer"
        className="mt-6 inline-block bg-white text-black px-8 py-3 rounded-lg w-[20%] text-lg font-medium shadow-md hover:bg-gray-200 transition text-center"
      >
        Get the app
      </a>
    </footer>
